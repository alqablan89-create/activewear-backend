  ...
  en: {
    translation: {
      ...
      checkout: {
        ...
        stripeNotConfigured: 'Stripe payment is not configured. Please contact the administrator.',
        ...
        tryAgain: 'Try Again',
        somethingWentWrong: 'Something went wrong with your payment. Please try again.',
      },
      shop: {
        filters: 'Filters',
        sortBy: 'Sort By',
  ...
  ar: {
    translation: {
      ...
      checkout: {
        ...
        stripeNotConfigured: 'لم يتم تكوين الدفع عبر Stripe. يرجى الاتصال بالمسؤول.',
        ...
        somethingWentWrong: 'حدث خطأ في الدفع. يرجى المحاولة مرة أخرى.',
      },
      shop: {
        filters: 'الفلاتر',
        sortBy: 'الترتيب حسب',
